...
public class UserInfoLocator extends org.apache.axis.client.Service implements xjtu.webservice.info.UserInfo {
    ...
    public xjtu.webservice.info.UserInfoPortType getUserInfoSOAP11port_http(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            xjtu.webservice.info.UserInfoSOAP11BindingStub _stub = new xjtu.webservice.info.UserInfoSOAP11BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (xjtu.webservice.info.UserInfoPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                xjtu.webservice.info.UserInfoSOAP11BindingStub _stub = new xjtu.webservice.info.UserInfoSOAP11BindingStub(new java.net.URL(UserInfoSOAP11port_http_address), this);
                _stub.setPortName(getUserInfoSOAP11port_httpWSDDServiceName());
                return _stub;
            }
        }
